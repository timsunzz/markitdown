...
const RECIPES = [
  ...
  },
  {
    ...
    steps: [
      '里脊切条，加盐、料酒腌 10 分钟，裹蛋液再滚一层干淀粉。',
      '油温六成热下锅炸 2 分钟捞出，升高油温复炸 30 秒更酥脆。',
      '另起锅：番茄酱 2 勺 + 糖 1 勺 + 醋 1 勺 + 水小半碗，熬至浓稠。',
      '倒入里脊快速翻裹糖醋汁，出锅。'
    ],
  ...
  },
  {
    ...
    steps: [
      '鸡腿肉切丁腌 10 分钟；调宫保汁：生抽 2 勺+醋 1.5 勺+糖 1 勺+淀粉半勺+水 2 勺。',
      '花生米冷油小火炸酥盛出。',
      '热油下鸡丁滑散至变色，下干辣椒段爆香。',
      '倒入宫保汁炒至浓稠，加黄瓜丁、葱段和花生米翻匀出锅。'
    ],
  ...
  },
  {
    ...
    steps: [
      '肉丝腌 10 分钟；调鱼香汁：生抽 1 勺+醋 2 勺+糖 1.5 勺+淀粉半勺+水 3 勺。',
      '热油滑散肉丝盛出。',
      '底油下豆瓣酱炒出红油，下木耳丝、胡萝卜丝、青椒丝炒 1 分钟。',
      '倒回肉丝和鱼香汁，大火炒至汁浓裹匀。'
    ],
  ...
  },
  {
    ...
    steps: [
      '茄子切滚刀块撒盐腌 10 分钟，挤干水分（少吸油的关键）。',
      '土豆块少油煎至金黄边，盛出；茄子同锅煎软盛出。',
      '下蒜末爆香，倒回土豆茄子，加青椒块。',
      '加生抽、蚝油和淀粉水，翻匀收汁。'
    ],
  ...
  },
  {
    ...
    steps: [
      '四季豆撕去老筋掰段，务必洗净。',
      '中小火多一点油，把四季豆煸至表皮起皱、完全熟透（约 5-6 分钟）。',
      '下蒜末爆香。',
      '加生抽和少许盐翻匀出锅。'
    ],
  ...
  },
  {
    ...
    steps: [
      '老豆腐切块用厨房纸吸干，四面滚一层干淀粉。',
      '平底锅多一点油，把豆腐每面煎至金黄脆壳。',
      '调汁：番茄酱 2 勺 + 生抽 1 勺 + 糖 1 勺 + 醋 1 勺 + 水 3 勺。',
      '倒入料汁裹匀收浓，撒葱花，外脆里嫩。'
    ],
